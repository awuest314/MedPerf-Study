...
#     elif dataset == 'task07':
#         feature_id = re.findall(r"[\w']+", feature_dir)[-3][-3:]
#         label_id = re.findall(r"[\w']+", label_dir)[-3][-3:]
#         assert feature_id == label_id, 'Feature and label mis-match: {0}'.format(feature_id)

#         feature_array = load_nifty_data(feature_dir)
#         feature_array = rotate_image(feature_array, 1)
#         feature_array = rotate_image(feature_array, 2, (1, 2))
#         feature_array = np.flip(feature_array, axis=-1)
#         feature_final = np.moveaxis(feature_array, -1, 0)
        
#         label_array = load_nifty_data(label_dir)
#         label_array = rotate_image(label_array, 1)
#         label_array = rotate_image(label_array, 2, (1, 2))
...
# output_tcia = data_preprocess(data_folder, 
#                               feature_folder_tcia, 
#                               label_folder_tcia, 
#                               'tcia', 
#                               parent_save_folder)
...
# data_folder = '/mnt/disks/lits-data/dfci-ai-pilot-federatedlearn/pancreas/'
# parent_save_folder = '/mnt/disks/lits-data/dfci-ai-pilot-federatedlearn/'
# feature_folder_synapse = 'synapse-train-images'
# label_folder_synapse = 'synapse-train-labels'

# output_synapse = data_preprocess(data_folder, 
#                                  feature_folder_synapse, 
#                                  label_folder_synapse, 
#                                  'synapse', 
#                                  parent_save_folder)

# data_folder = '/mnt/disks/lits-data/dfci-ai-pilot-federatedlearn/pancreas/'
# parent_save_folder = '/mnt/disks/lits-data/dfci-ai-pilot-federatedlearn/'
# feature_folder_task07 = 'task07-train-images'
# label_folder_task07 = 'task07-train-labels'

# output_task07 = data_preprocess(data_folder, 
#                                 feature_folder_task07, 
#                                 label_folder_task07, 
#                                 'task07', 
#                                 parent_save_folder)
...
#         feature_array = load_dicom_data(feature_dir)
#         feature_array = rotate_image(feature_array, 2, (1, 2))
#         feature_array = rotate_image(feature_array, 2, (0, 2))
#         feature_final = np.flip(feature_array, axis=0)
#         # feature_final = feature_array
...
#         # label_array = rotate_image(label_array, 2)
#         # label_final = np.moveaxis(label_array, -1, 0)
#         label_final = rotate_image(label_array, 1, (1, 2))
#         # label_final = rotate_image(label_array, 2, (0, 2))
        
# task07_i = '/mnt/disks/lits-data/dfci-ai-pilot-federatedlearn/pancreas/task07-train-images/pancreas_001.nii.gz'
# task07_l = '/mnt/disks/lits-data/dfci-ai-pilot-federatedlearn/pancreas/task07-train-labels/pancreas_001.nii.gz'

# synapse_i = '/mnt/disks/lits-data/dfci-ai-pilot-federatedlearn/pancreas/synapse-train-images/img0001.nii.gz'
# synapse_l = '/mnt/disks/lits-data/dfci-ai-pilot-federatedlearn/pancreas/synapse-train-labels/label0001.nii.gz'

# tcia_i = '/mnt/disks/lits-data/dfci-ai-pilot-federatedlearn/pancreas/TCIA-images/PANCREAS_0001'
# tcia_l = '/mnt/disks/lits-data/dfci-ai-pilot-federatedlearn/pancreas/TCIA-labels/label0001.nii.gz'

# for i in range(feature_task07.shape[0]):
#     if np.sum(label_task07[i, :, :]*255) > 0:
#         fig, ax = plt.subplots(1, 2, figsize=(20, 10))
#         ax[0].imshow(feature_task07[i, :, :]*255, cmap='gray')
#         ax[1].imshow(feature_task07[i, :, :]*255, cmap='gray')
#         ax[1].imshow(label_task07[i, :, :], cmap='Wistia', alpha=0.7)
#         ax[0].axis('off')
#         ax[1].axis('off')
#         plt.show()
...
#     logger.info("Parameters have been read (%s).", args.parameters_file)
    ...
    # label = args.get("label_path")
    # out = args.get("out")
    # prepare(data_id, path, out)
